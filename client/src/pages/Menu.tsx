                    ...
                    <CardContent className="pt-4">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          {/* Coin-ineligible badge: shown for items where the
                              menuItems.coinEligible flag is false (Mix Grill +
                              meal-deal categories). 10% member discount still
                              applies — only the coin redemption is excluded. */}
