...
ALTER TABLE `fudaClubSubscriptions` ADD COLUMN `isFoundingMember` boolean NOT NULL DEFAULT false;
--> statement-breakpoint
ALTER TABLE `fudaClubSubscriptions` ADD COLUMN `lockedPriceUntil` timestamp NULL;
--> statement-breakpoint
